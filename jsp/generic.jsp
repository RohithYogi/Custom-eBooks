		...
		<div class="container">
			...
			<div class="col-md-6 col-sm-6 animate-box">
				<div class="feature-center">
					...
					<div class="desc">
						<h3>Web Design</h3>
						<p>This application uses html5, bootstrap, css, javascript along with a few other technologies that include jsp, java, xml and apache-tomcat.</p>
					</div>
				</div>
			</div>
			<div class="col-md-6 col-sm-6 animate-box">
				<div class="feature-center">
					...
					<div class="desc">
						...
						<p>We will add the link to the video tutorial here when we finish this application and deploy it for real.</p>
					</div>
				</div>
			</div>
			<div class="col-md-6 col-sm-6 animate-box">
				<div class="feature-center">
					...
					<div class="desc">
						...
						<p>There is no 24/7 help and support as of now but when you continue to develop this application further be sure include one for the users.</p>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="container">
			<div class="row animate-box">
				<div class="col-md-8 col-md-offset-2 text-center fh5co-heading">
					<h2>Newsletter</h2>
					<p>Stay up to date with changes made to the application via our newsletter.</p>
				</div>
			</div>
			<div class="row animate-box">
